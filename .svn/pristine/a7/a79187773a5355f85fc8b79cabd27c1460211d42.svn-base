...
<script src="<%=baseurl%>/html/main/customer/update_customer.js"></script>
...
<body>
	...
	<table border="1" class="table table-striped" style="width: 100%">
		...
		<tr>
			<td>编号</td>
			<td><input id="code" type="text" size="2"
				class="form-control" style="width: 30%"></td>
		</tr>
		<tr>
			<td>标签</td>
			<td><input id="tag" type="text" size="2"
				class="form-control" style="width: 30%"></td>
		</tr>
		<tr>
			<td>上一级</td>
			<td><input id="parent" type="text" size="2"
				class="form-control" style="width: 30%"></td>
		</tr>
