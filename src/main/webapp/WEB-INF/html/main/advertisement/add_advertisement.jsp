...
<body>
	<table border="1" class="table table-striped" style="width: 100%">
		...
		<tr>
			<td>广告类型</td>
			<td><select id="type_id" name="type_id"style="width: 30%" class="form-control">
			<option value="01">图片广告</option>
			<option value="02">文本广告</option>
			<option value="03">视频广告</option>
			</select>
		</tr>
		<tr>
			<td>是否轮播</td>
		...
		<tr>
			<td>是否上架</td>
			<td style="text-align: left;"><input type="radio" name="is_enable" value="01" checked="checked" style="transform:scale(1.2);width:20px;" \">上架<input type="radio" name="is_enable" value="02"  style="transform:scale(1.2);width:20px;">下架
			</td>
		</tr>
		<tr>
			<td>轮播时长</td>
