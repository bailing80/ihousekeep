...
//		 rm = con.get(i);
//	}
	System.out.println("1213212313212313132");
	...
	for(int j= 0;j<role_id.length;j++){
		System.out.println(role_id+"=role_id");
				for(int i=0;i<con.size();i++){
					...
					rm.getRole_id();
					rm.getMenu_id();
						System.out.println(rm.getRole_id()+"  "+rm.getMenu_id());
...
public void delete_all_t_s_role_2_menu(T_s_role_2_menu t_s_role_2_menu) {
	...
	try{
		for (String string : ids) {
			T_s_role_2_menu t =new T_s_role_2_menu();
			t.setId(string);
			t_s_role_2_menu_dao_iface.delete_t_s_role_2_menu2(t);
		}
	}catch(Exception e){
		e.printStackTrace();
	}
...
public void delete_t_s_role_2_menu2(T_s_role_2_menu t_s_role_2_menu) throws Exception {
	// TODO Auto-generated method stub
	t_s_role_2_menu_dao_iface.delete_t_s_role_2_menu2(t_s_role_2_menu);
}
