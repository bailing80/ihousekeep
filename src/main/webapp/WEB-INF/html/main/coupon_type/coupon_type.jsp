...
<script type="text/javascript" src="<%=baseurl%>/js/up_down_load.js"></script>
 <script type="text/javascript"
	src="<%=baseurl%>/html/main/coupon_type/coupon_type.js"></script>
...
<body>
	<div id="nav" class="btn-group">
		<span class="label label-default">优惠劵类型设置</span>
	</div>
	<div id="fun" class="btn-group" data-toggle="buttons-checkbox">
		<button class="btn btn-primary" id="add_coupon_type"
			style="float: left">新增</button>
		<button class="btn btn-primary" id="delete_coupon_type">删除</button>
		<button class="btn btn-primary" id="query_coupon_type"
			style="float: left">查询</button>
		<input id="querydata" type="text" size="2" class="form-control"
			style="width: 30%" placeholder="请输入优惠券类型名称查询......" value="">
	</div>
	<div id="content">
