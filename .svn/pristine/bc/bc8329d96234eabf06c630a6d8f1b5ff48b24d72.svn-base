...
<script type="text/javascript" src="<%=baseurl%>/html/main/serviceproject/serviceproject.js"></script>
</head>
<body>

	<div id="nav" class="btn-group">
		<span class="label label-default">首页分类</span>
	</div>
		<div id="fun" class="btn-group" data-toggle="buttons-checkbox">
		<button class="btn btn-primary" id="add_serviceproject" style="float: left">新增</button>
		<button class="btn btn-primary" id="delete_serviceproject">删除</button>
		<button class="btn btn-primary" id="query_serviceproject" style="float: left">查询</button>
		<input id="querydata" type="text" size="2" class="form-control"
			style="width: 30%" placeholder="请输入查询广告名称关键字......" value="">
	</div>
	<div id="content">
